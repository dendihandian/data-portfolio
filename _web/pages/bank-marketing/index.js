        ...
        res = (
            <div className="content w-full flex flex-wrap">
                ...
                <div className="w-full md:w-1/4 min-h-96 flex justify-center items-center relative py-16">
                    ...
                    <button className="absolute bg-transparent border-2 hover:border-teal-600 border-teal-500 rounded p-4 px-8 font-bold text-white hover:text-teal-500 bg-true-gray-800 ">Predict!</button>
                </div>
